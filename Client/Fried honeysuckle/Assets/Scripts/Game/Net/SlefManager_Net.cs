...
public class SlefManager_Net : MonoBehaviour
{
    #region 字段
    ...
    private ZjhManager_Net m_ZjhManager_Net;
    ...
    private void Init()
    {
        ...
        m_ZjhManager_Net = GetComponentInParent<ZjhManager_Net>();
    ...
    {
        if (giveIpUserId==Models.GameModel.userDto.UserId)
        {
    ...
    private void DealCard(PlayerDto dto)
    {
        ...
        {
            DealCard(0.3f, new Vector3(0, 345.22f, 0));
        }
        DealCardFinished();
    }
    ...
    private void OnCompareButtonClick()  
    {
        ...
        if (m_ZjhManager_Net.LeftIsGiveUp||m_ZjhManager_Net.LeftIsLeave)
        {
            btn_CompareLeft.gameObject.SetActive(false);
        }
        if (m_ZjhManager_Net.RightIsGiveUp || m_ZjhManager_Net.RightIsLeave)
        {
            btn_CompareRight.gameObject.SetActive(false);
        }
